...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-16 gap-4 items-end rounded-2xl px-4 pb-3 frosted-glass z-10", // Ensure z-index is high enough
        className
      )}
      style={{ bottom: "4rem", position: "fixed", left: "50%", transform: "translateX(-50%)" }} // Dock stays fixed above the footer
    >
      {items.map((item) => (
